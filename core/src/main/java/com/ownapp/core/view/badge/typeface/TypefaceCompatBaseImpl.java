...
class TypefaceCompatBaseImpl {
    ...
    private java.util.concurrent.ConcurrentHashMap<Long, FontResourcesParserCompat.FontFamilyFilesResourceEntry>
    ...
    protected FontsContractCompat.FontInfo findBestInfo(FontsContractCompat.FontInfo[] fonts, int style) {
        return findBestFont(fonts, style, new StyleExtractor<FontsContractCompat.FontInfo>() {
            @Override
    ...
    private FontResourcesParserCompat.FontFileResourceEntry findBestEntry(FontResourcesParserCompat.FontFamilyFilesResourceEntry entry, int style) {
        return findBestFont(entry.getEntries(), style, new StyleExtractor<FontResourcesParserCompat.FontFileResourceEntry>() {
            @Override
    ...
    public Typeface createFromFontFamilyFilesResourceEntry(Context context,
                                                           FontResourcesParserCompat.FontFamilyFilesResourceEntry entry, Resources resources, int style) {
