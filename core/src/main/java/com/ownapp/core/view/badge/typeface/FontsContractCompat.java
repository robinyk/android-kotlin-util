...
import com.ownapp.core.view.badge.resource.ResourcesCompat.FontCallback;
import com.ownapp.core.view.badge.util.Preconditions;
import com.ownapp.core.view.badge.util.SelfDestructiveThread;
import com.ownapp.core.view.badge.util.SelfDestructiveThread.ReplyCallback;
...
public class FontsContractCompat {
    ...
    @GuardedBy("sLock")
    static final SimpleArrayMap<String, ArrayList<SelfDestructiveThread.ReplyCallback<TypefaceResult>>>
    ...
    public static Typeface getFontSync(final Context context, final FontRequest request,
            final @Nullable FontCallback fontCallback,
        ...
        if (isBlockingFetch) {
            ...
            final SelfDestructiveThread.ReplyCallback<TypefaceResult> reply = fontCallback == null ? null
