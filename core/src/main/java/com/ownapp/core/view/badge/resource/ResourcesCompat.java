...
import com.ownapp.core.view.badge.typeface.FontResourcesParserCompat;
import com.ownapp.core.view.badge.typeface.FontsContractCompat;
import com.ownapp.core.view.badge.typeface.TypefaceCompat;
    ...
    public static void getFont(@NonNull Context context, @FontRes int id,
        ...
        if (context.isRestricted()) {
            fontCallback.callbackFailAsync(
                    FontsContractCompat.FontRequestCallback.FAIL_REASON_SECURITY_VIOLATION, handler);
            return;
        }
    ...
    private static Typeface loadFont(
        ...
        if (!file.startsWith("res/")) {
            ...
            if (fontCallback != null) {
                fontCallback.callbackFailAsync(
                        FontsContractCompat.FontRequestCallback.FAIL_REASON_FONT_LOAD_ERROR, handler);
            }
            return null;
        }
        ...
        try {
            if (file.toLowerCase().endsWith(".xml")) {
                ...
                if (familyEntry == null) {
                    Timber.e("Failed to find font-family tag");
                    if (fontCallback != null) {
                        fontCallback.callbackFailAsync(
                                FontsContractCompat.FontRequestCallback.FAIL_REASON_FONT_LOAD_ERROR, handler);
                    }
            ...
            Timber.e(e, "Failed to parse xml resource %s", file);
        } catch (IOException e) {
            Timber.e(e, "Failed to read xml resource %s", file);
        }
        if (fontCallback != null) {
            fontCallback.callbackFailAsync(
                    FontsContractCompat.FontRequestCallback.FAIL_REASON_FONT_LOAD_ERROR, handler);
                ...
                synchronized (sRebaseMethodLock) {
                    if (!sRebaseMethodFetched) {
                        try {
                            ...
                            Timber.i(e, "Failed to retrieve rebase() method");
                        }
                    ...
                    if (sRebaseMethod != null) {
                        try {
                            ...
                            Timber.i(e, "Failed to invoke rebase() method via reflection");
                            sRebaseMethod = null;
                        }
                    }
                }
